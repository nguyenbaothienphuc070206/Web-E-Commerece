        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-8">
          ...
          <div>
            ...
            <ul className="space-y-2 text-gray-400 text-sm">
              <li>
                <a href="/products?category=Phone" className="hover:text-primary transition">
                  Phone
                </a>
              </li>
              <li>
                <a href="/products?category=Laptop" className="hover:text-primary transition">
                  Laptop
                </a>
              </li>
              <li>
                <a href="/products?category=AirPod" className="hover:text-primary transition">
                  AirPod
                </a>
              </li>
              <li>
          ...
          <div>
            ...
            <ul className="space-y-2 text-gray-400 text-sm">
              ...
              <li>
                <a href="/warranty" className="hover:text-primary transition">
                  Warranty
                </a>
              </li>
              <li>
